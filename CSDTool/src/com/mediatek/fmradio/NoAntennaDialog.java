...
public class NoAntennaDialog extends DialogFragment {
    ...
    // XXX ***************
    public static NoAntennaDialog newInstance(NoAntennaListener listener) {

        return new NoAntennaDialog(listener);
    }

    public NoAntennaDialog() {

    }

    public NoAntennaDialog(NoAntennaListener listener) {
        mListener = listener;
    }
