...
import com.mlt.csdfactorytest.item.AbsHardware;
import com.mlt.csdfactorytest.item.AbsHardware.TestResult;
import com.mlt.csdfactorytest.item.MyApplication;
import com.mlt.csdfactorytest.item.tools.TestItemTool;
...
public class ItemTestActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bar = (LinearLayout)this.findViewById(R.id.pass_fail_bar);
		mbtnPass = (Button) findViewById(BUTTON_PASS);
		mbtnFail = (Button) findViewById(BUTTON_FAIL);
		mHW.onCreate();
	}
	/**
	...
	private void loadData() {
		...
		//pss add FactoryTesst for keyAndmotor 20150714
        MyApplication.saveClassNameUseSharePreference(this, MyApplication.getCurrentTestClassName(position));
        //pss add FactoryTesst for keyAndmotor 20150714
