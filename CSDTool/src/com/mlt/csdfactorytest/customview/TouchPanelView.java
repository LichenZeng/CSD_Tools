package com.mlt.csdfactorytest.customview;
...
import com.mlt.csdfactorytest.item.TouchPanel;
...
//		int residueH = height%step;
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		*/
		...
		// laiyang modify for VFOZBENQ-78 20150918 start
		// Modify the test way, multitouch test can be repeated test now 
		// old code:
		...
		if(((MotionEvent.ACTION_DOWN == event.getAction()) || 
            (MotionEvent.ACTION_POINTER_DOWN == (event.getAction() & MotionEvent.ACTION_MASK))) && pointerCount > 0) {
		// laiyang modify for VFOZBENQ-78 20150918 end
