package com.mlt.csdfactorytest.adapter;
...
import java.util.Arrays;//pss add for VFOZBENQ-211
/**
 * 
...
public class TestItemAdapter implements ListAdapter {
	...
	public TestItemAdapter(Context context) {
		...
		//pss add for VFOZBENQ-211 start
		String[] hwTexts = context.getResources().getStringArray(R.array.testitems);
		MyApplication.setHWTexts(Arrays.asList(hwTexts));
		//pss add for VFOZBENQ-211  end
